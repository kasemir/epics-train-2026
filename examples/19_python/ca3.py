...
# Create 3 PVs
pv1 = epics.get_pv(user + ':setpoint')
pv2 = epics.get_pv(user + ':room')
pv3 = epics.get_pv(user + ':sensor')
...
# 'use_complete' only makes a difference
# for PVs that actually support completion
# (see 'busy' record)
